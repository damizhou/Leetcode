...
class Day29_ConstructtheRectangle_492 : NSObject {
    ...
    private class func constructRectangle(_ area: Int) -> [Int] {
        var squareRoot = Int(sqrt(Double(area)))
    ...
    class func solution() {
        let area = 6
        let result = self.constructRectangle(area)
