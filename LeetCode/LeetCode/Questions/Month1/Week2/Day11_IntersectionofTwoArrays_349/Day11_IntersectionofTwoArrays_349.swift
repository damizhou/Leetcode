...
class Day11_IntersectionofTwoArrays_349: NSObject {
    ...
    ///
    /// - returns: 交集数组
    private class func intersection(_ nums1: [Int], _ nums2: [Int]) -> [Int] {
        var result = [Int]()
    ...
    /// 解法2:利用集合可以删除特定元素的特性
    private class func intersection2(_ nums1: [Int], _ nums2: [Int]) -> [Int] {
        var result = [Int]()
